...
const additionalWords = [
  ...
  { text: "Chase", type: "custom", isCharacterWord: true },
  { text: "Marshall", type: "custom", isCharacterWord: true },
  { text: "Skye", type: "custom", isCharacterWord: true },
  { text: "Rubble", type: "custom", isCharacterWord: true },
  { text: "Rocky", type: "custom", isCharacterWord: true },
  { text: "Zuma", type: "custom", isCharacterWord: true },
  { text: "Ryder", type: "custom", isCharacterWord: true },
  { text: "Humdinger", type: "custom", isCharacterWord: true },
  // Story-specific words
  { text: "pup", type: "custom" },
  { text: "pups", type: "custom" },
  { text: "Paw", type: "custom" },
  { text: "Patrol", type: "custom" },
  { text: "Lookout", type: "custom" },
  { text: "Adventure", type: "custom" },
  { text: "Bay", type: "custom" },
  { text: "tower", type: "custom" },
  { text: "bridge", type: "custom" },
  { text: "chicken", type: "custom" },
  { text: "cats", type: "custom" },
  { text: "mission", type: "custom" },
  { text: "case", type: "custom" },
  { text: "mess", type: "custom" },
  { text: "mop", type: "custom" },
  { text: "hill", type: "custom" },
  { text: "tree", type: "custom" },
  // Action words
  { text: "fly", type: "custom" },
  { text: "swim", type: "custom" },
  { text: "dig", type: "custom" },
  { text: "fix", type: "custom" },
  { text: "save", type: "custom" },
  { text: "fire", type: "custom" },
  { text: "clean", type: "custom" },
  { text: "work", type: "custom" },
  { text: "ran", type: "custom" },
  { text: "went", type: "custom" },
  { text: "get", type: "custom" },
  // Other words
  { text: "fast", type: "custom" },
  { text: "high", type: "custom" },
  { text: "under", type: "custom" },
  { text: "water", type: "custom" },
  { text: "day", type: "custom" },
  { text: "way", type: "custom" },
  { text: "them", type: "custom" },
  { text: "this", type: "custom" },
  { text: "us", type: "custom" },
  { text: "yes", type: "custom" },
  { text: "no", type: "custom" },
  { text: "now", type: "custom" },
  { text: "all", type: "custom" },
  { text: "have", type: "custom" },
  { text: "are", type: "custom" },
  { text: "on", type: "custom" },
  { text: "at", type: "custom" },
  { text: "must", type: "custom" },
  { text: "please", type: "custom" },
  { text: "together", type: "custom" },
  { text: "everything", type: "custom" },
  { text: "saved", type: "custom" },
  { text: "trouble", type: "custom" },
  { text: "there", type: "custom" },
  { text: "What", type: "custom" },
  { text: "Where", type: "custom" },
  { text: "They", type: "custom" },
  { text: "Let", type: "custom" },
  { text: "Yes", type: "custom" },
  { text: "All", type: "custom" },
];
